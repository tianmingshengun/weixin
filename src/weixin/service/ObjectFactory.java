 ...
 * generated in the weixin.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://webservice.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://webservice.com/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: weixin.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "sayResponse")
